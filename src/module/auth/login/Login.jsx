...
export function Login() {
  ...
  const [errorMessage, setErrorMessage] = useState('');
    ...
    const loginSchema = object().shape({
        ...
        password: string().min(6, "At least 6 characters required").required("Password is required")
    })
    ...
    <section>
      <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
        <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
          ...
          {errorMessage &&  
          <p className="mt-2 text-center text-lg text-red-900 ">
           {errorMessage}
         </p>}
            ...
            <div className="space-y-5">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <Link to='/forgetpassword'  title="" className="text-sm font-semibold text-black hover:underline">
                    {' '}
                    Forgot password?{' '}
                  </Link>
                </div>
